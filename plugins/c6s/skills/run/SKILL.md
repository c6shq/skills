...
executable, arguments, working directory, item and field IDs, revision, and
...
field eligibility, consumes the short-lived grant atomically, invokes the executable
without a shell, and redacts exact injected values from bounded stdout and stderr.
